...
// ExampleLatencySimplest is the simplest way of getting information about latency of your operation.
// Read more in "Efficient Go"; Example 6-1.
...
// ExampleLatencyAggregated shows a way of getting information about aggregated latency of your operation.
// Read more in "Efficient Go"; Example 6-2.
...
// Simplest benchmark.
// Read more in "Efficient Go"; Example 6-3.
...
// Example of getting operation latency and exposing it through a log line metric.
// Read more in "Efficient Go"; Example 6-4.
...
// Example of getting operation latency from tracing instrumentation.
// Read more in "Efficient Go"; Example 6-6.
...
// Example of getting operation latency and exposing it through Prometheus metric.
// Read more in "Efficient Go"; Example 6-7.
		...
		for ctx.Err() == nil {
			...
			if span.Context().IsSampled() {
				latencySeconds.WithLabelValues(errorType(err)).(prometheus.ExemplarObserver).ObserveWithExemplar(
					elapsed.Seconds(), map[string]string{"traceID": span.Context().TraceID()})
			} else {
